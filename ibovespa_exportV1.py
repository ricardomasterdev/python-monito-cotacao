...
# === Dicionários de preenchimento - exemplo completo ===
setor_map = {
...
cotacoes, var_12m, var_mes, var_dia = [], [], [], []

# Coleta automática das cotações e variações, com barra de progresso
total = len(tickers)
...
df.to_excel("acoes_ibov_completo.xlsx", index=False)
print("Arquivo Excel salvo como: acoes_ibov_completo.xlsx")
...
colunas = df.columns
larguras = [20, 35, 22, 30, 25, 20, 20, 20, 22, 28, 22, 40]
...
pdf.output("acoes_ibov_completo.pdf")
print("Arquivo PDF salvo como: acoes_ibov_completo.pdf")
